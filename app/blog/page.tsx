...
// Remove the revalidate and metadata exports since we're now a client component
...
export default function Blog() {
    ...
    useEffect(() => {
        ...
        document.title = 'Blog | Le Vo Quyet Thang';
            ...
            <main className="pt-32 pb-20 px-4 container mx-auto">
                ...
                {isLoading ? (
                    <div className="flex justify-center items-center h-64">
                        <div className="text-neon-blue">Loading blog posts...</div>
                    </div>
                ) : (
